        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              {/* Opnieuw knop - verschijnt links van mute button */}
              {currentStep > 0 && (
                <button
                  onClick={handleReset}
                  className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg transition-all duration-200 hover:scale-105 text-white/90 hover:text-white"
              ...
              <button
                ...
                >
          <button
            className="flex items-center justify-center w-10 h-10 bg-white/10 hover:bg-white/20 rounded-lg transition-all duration-200 hover:scale-105 text-white/90 hover:text-white order-2"
          ...
          {(currentStep > 0 || selectedCase) && (
            <button
              onClick={handleReset}
              className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg transition-all duration-200 hover:scale-105 text-white/90 hover:text-white order-1"
              title="Opnieuw beginnen"
            >
              <RotateCcw className="w-4 h-4" />
              Opnieuw
                ...
                >
                  {isGeneratingTitles ? (
                    ...
                    <>
                      ...
                      <span>Genereer Casus Opties</span>
