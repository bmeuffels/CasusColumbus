            ...
            {selectedFields.length > 0 && selectedTopics.length > 0 && (
              <div className="flex justify-center">
                <button
                  ...
                  className="bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white px-8 py-4 rounded-2xl shadow-lg transition-all duration-200 hover:scale-105 flex items-center gap-3 text-lg font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isGeneratingTitles ? (
                    <>
          ...
          <div className="space-y-8">
            ...
            <div className="backdrop-blur-xl bg-white/60 rounded-3xl shadow-lg border border-blue-200/50 p-8">
              <div className="mb-6">
                ...
                <p className="text-gray-600">Selecteer de casus die het beste past bij jouw situatie.</p>
              </div>
              ...
              <div className="grid gap-4">
                {caseTitles.map((caseTitle, index) => (
                  <button
                    ...
                    className="p-6 rounded-2xl border-2 border-gray-200 bg-white/80 hover:border-blue-300 hover:bg-blue-50/50 transition-all duration-300 text-left group hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <h3 className="font-semibold text-gray-800 mb-2 text-lg">{caseTitle.title}</h3>
              ...
              {isGenerating && (
                <div className="flex justify-center mt-8">
                  <div className="flex items-center gap-3 text-blue-600">
                    <RefreshCw className="w-6 h-6 animate-spin" />
                    <span className="text-lg font-medium">Casus wordt gegenereerd...</span>
                  </div>
                </div>
              )}
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="backdrop-blur-xl bg-white/60 rounded-3xl shadow-lg border border-blue-200/50 p-8">
              <div className="mb-6">
                ...
                <p className="text-gray-600">Lees de casus door en gebruik het ethisch kompas om de relevante dimensies te identificeren.</p>
              </div>
                ...
                {ETHICAL_DIMENSIONS.map((dimension) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      <h3 className="font-semibold text-gray-800 text-sm">{dimension.name}</h3>
                      {selectedDimensions.includes(dimension.id) && (
              ...
              {selectedDimensions.length === requiredSelections && !showFeedback && (
                <div className="flex justify-center">
                  <button
                    ...
                    className="bg-gradient-to-r from-purple-600 to-indigo-700 hover:from-purple-700 hover:to-indigo-800 text-white px-6 py-3 rounded-2xl shadow-lg transition-all duration-200 hover:scale-105 flex items-center gap-2"
                  >
                ...
                <div className="mt-6 space-y-4">
                  <div className="bg-white/80 rounded-2xl p-6 border border-gray-200">
                    <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center gap-2">
                      ...
                      Feedback op jouw selectie
                    </h3>
                    
                    {/* Correct Dimensions */}
                    <div className="mb-4">
                      <h4 className="font-medium text-green-700 mb-2">✓ Correcte dimensies voor deze casus:</h4>
                      <div className="flex flex-wrap gap-2">
                        {result.correctDimensions.map((dimId) => {
                          const dimension = ETHICAL_DIMENSIONS.find(d => d.id === dimId);
                          return dimension ? (
                            <span key={dimId} className="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm">
                              {dimension.name}
                            </span>
                          ) : null;
                        })}
                    ...
                    {/* User's Selection Analysis */}
                    <div className="mb-4">
                      <h4 className="font-medium text-gray-700 mb-2">Jouw selectie:</h4>
                      <div className="flex flex-wrap gap-2">
                      ...
                      <div className="mb-4">
                        ...
                        <div className="space-y-2">
                          {result.explanations.map((explanation, index) => (
                            <p key={index} className="text-gray-600 text-sm bg-blue-50 p-3 rounded-lg">
                              {explanation}
                            </p>
                          ))}
                        </div>
                    ...
                    <div className="flex gap-3 mt-6">
                      ...
                      <button
                        ...
                        className="bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white px-4 py-2 rounded-lg shadow-lg transition-all duration-200 hover:scale-105 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        {isExpandingCase ? (
                          <>
          ...
          <div className="space-y-8">
            ...
            <div className="backdrop-blur-xl bg-white/60 rounded-3xl shadow-lg border border-blue-200/50 p-8">
              <div className="mb-6">
                ...
                <p className="text-gray-600">De casus is uitgebreid met meer details en context.</p>
              </div>
                  ...
                  {result.stakeholders.map((stakeholder, index) => (
                    <div key={index} className="bg-white/80 rounded-2xl p-6 border border-gray-200">
                      <div className="flex items-start gap-4">
                        <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-green-500 to-emerald-600 flex items-center justify-center text-white font-bold text-lg">
                          {stakeholder.role.charAt(0).toUpperCase()}
                        </div>
                        <div className="flex-1">
                          <h3 className="font-semibold text-gray-800 text-lg mb-2">{stakeholder.role}</h3>
                          <div className="space-y-3">
                            <div>
                              <h4 className="font-medium text-gray-700 mb-1">Belangen:</h4>
                              <p className="text-gray-600 text-sm">{stakeholder.interests}</p>
                            </div>
                            <div>
                              <h4 className="font-medium text-gray-700 mb-1">Perspectief:</h4>
            ...
            <div className="flex justify-center gap-4">
              <button
                onClick={handleReset}
                className="bg-gradient-to-r from-orange-500 to-yellow-400 hover:from-orange-600 hover:to-yellow-500 text-white px-6 py-3 rounded-2xl shadow-lg transition-all duration-200 hover:scale-105 flex items-center gap-2"
              >
